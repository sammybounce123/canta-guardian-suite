  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">Portal configuration and user management</p>
      </div>
          ...
          <Card className="bg-card border-border">
            ...
            <CardContent className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                ...
                <Input type="number" defaultValue={30} className="w-20 bg-muted border-none text-right" />
              </div>
              <div className="flex items-center justify-between">
                <div>
              ...
              <div className="flex items-center justify-between">
                ...
                <Input type="number" defaultValue={10000} className="w-28 bg-muted border-none text-right font-mono" />
              </div>
            </CardContent>
          </Card>
        </TabsContent>
